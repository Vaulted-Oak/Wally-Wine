...
export function OrderCard({order}: {order: OrderCardFragment}) {
  ...
  return (
    <li className="grid rounded border border-[#cccccc] text-center">
      <Link
      ...
      >
        ...
        >
          <div className="text-lg font-normal leading-[25px] mb-[20px]">
            {lineItems.length > 1
      ...
      <div className="self-end border-t border-[#cccccc]">
        <Link
          className="block text-primaryGreen hover:underline w-full p-2 text-center"
          prefetch="intent"
          to={url}
        >
