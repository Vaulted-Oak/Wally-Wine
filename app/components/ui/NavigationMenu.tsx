...
>(({children, className, ...props}, ref) => (
  <NavigationMenuPrimitive.Root
    className={cn(
      'relative z-[51] flex max-w-max flex-1 items-center justify-center',
      className,
    )}
    ref={ref}
    {...props}
...
>(({className, ...props}, ref) => (
  <NavigationMenuPrimitive.List
    className={cn(
      'group flex flex-1 list-none items-center xl:gap-[50px] lg:gap-[15px] justify-center menu-items',
      className,
    )}
    ref={ref}
    {...props}
