...
export function useColorsCssVars(props: {
  ...
  return `
    ${selector} {
      ...
      --background: ${toRgbString(colorScheme.background?.rgb)} ${props.important ? '!important' : ''};
      ...
      --foreground: ${toRgbString(colorScheme.foreground?.rgb)} ${props.important ? '!important' : ''};
      ...
      --paddingBottom: ${paddingBottom} ${props.important ? '!important' : ''};
      --paddingTop: ${paddingTop} ${props.important ? '!important' : ''};
