...
export const action: ActionFunction = async ({context, params, request}) => {
  ...
  const requiredFields: (keyof CustomerAddressInput)[] = [
    'lastName',
    'firstName',
    'address1',
    'city',
  ...
  const errors: CustomerAddressInput = {};
    ...
    if (!address[field]) {
      switch (field) {
        ...
        case 'city':
          ...
          break;
        case 'zoneCode':
          errors[field] = 'State / Province is required';
          break;
        case 'zip':
  ...
  if (addressId === 'add') {
    try {
      ...
      if(data?.customerAddressCreate?.userErrors?.[0]?.message){
        return json(
          {formError: data?.customerAddressCreate?.userErrors?.[0]?.message},
          { headers: {
            'Set-Cookie': await context.session.commit(),
          },
          status: 400,
    ...
    try {
      ...
      if(data?.customerAddressUpdate?.userErrors?.[0]?.message){
        return json(
          {formError: data?.customerAddressUpdate?.userErrors?.[0]?.message},
          { headers: {
            'Set-Cookie': await context.session.commit(),
          },
          status: 400,
        ...
        <Form method="post">
          ...
          <div className="mt-3">
            ...
            {actionData?.errors?.firstName ? (
              <em className="text-primaryRed mt-[10px] block">{actionData?.errors?.firstName}</em>
          ) : null}
          </div>
          <div className="mt-3">
            <Input
            ...
            {actionData?.errors?.lastName ? (
              <em className="text-primaryRed mt-[10px] block">{actionData?.errors?.lastName}</em>
          ) : null}
          </div>
          <div className="mt-3">
            <Input
          ...
          <div className="mt-3">
            ...
            {actionData?.errors?.address1 ? (
              <em className="text-primaryRed mt-[10px] block">{actionData?.errors?.address1}</em>
          ) : null}
          </div>
          <div className="mt-3">
            <Input
          ...
          <div className="mt-3">
            ...
            {actionData?.errors?.city ? (
              <em className="text-primaryRed mt-[10px] block">{actionData?.errors?.city}</em>
          ) : null}
          </div>
          <div className="mt-3">
            <Input
              ...
              type="text"
            />
            {actionData?.errors?.zoneCode ? (
              <em className="text-primaryRed mt-[10px] block">{actionData?.errors?.zoneCode}</em>
          ) : null}
          </div>
          <div className="mt-3">
            <Input
            ...
            {actionData?.errors?.zip ? (
              <em className="text-primaryRed mt-[10px] block">{actionData?.errors?.zip}</em>
          ) : null}
          </div>
          <div className="mt-3">
            <Input
              ...
              type="text"
            />
            {actionData?.errors?.territoryCode ? (
              <em className="text-primaryRed mt-[10px] block">{actionData?.errors?.territoryCode}</em>
          ) : null}
          </div>
          <div className="mt-3">
            <Input
