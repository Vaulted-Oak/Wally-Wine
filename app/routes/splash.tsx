...
import { SPLASH_PAGE_QUERY } from '~/qroq/queries';
            ...
            <Fragment key={section._key}>
                ...
                {section._type === "videoSection" ? (
                    <div className='absolute inset-0 flex items-center justify-center'>
                        <button className="mt-6 p-3 bg-[#00461C] color-[#FFFFFF]" onClick={handleContinue}>Shop Wally's</button>
                        <button className="mt-6 p-3 bg-[#FFFFFF] color-[#00461C]" onClick={handleContinue}>Dine with us</button>
                    </div>
                ) : null}
            </Fragment>
        ))
