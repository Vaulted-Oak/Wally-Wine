  ...
  return (
    <div className="container py-10">
      <div className="flex items-center justify-between">
        <h1 className="uppercase tracking-[2px]">{heading}</h1>
        <Form action={path} className="" method="post">
          <Button className="p-0 font-normal" type="submit" variant="link">
  ...
  return (
    <div className="mt-6">
      <div className="grid w-full gap-4 py-6 md:gap-8">
        <h2 className="text-[32px]">{themeContent?.account.orderHistory}</h2>
