...
> & {
  ...
  expertRated?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
  >;
  topPick?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
  >;
  futures?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
  >;
};
  ...
  blog?: StorefrontAPI.Maybe<{
    articleByHandle?: StorefrontAPI.Maybe<
      ...
      > & {
        ...
        comments: {
          edges: Array<{
            node: Pick<StorefrontAPI.Comment, 'content'> & {
              author: Pick<StorefrontAPI.CommentAuthor, 'name'>;
            };
          }>;
        };
      }
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      pairings?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      sku?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      wineType?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      varietal?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      usStates?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      size?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      region?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      product?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      ...
      country?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      appellation?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      vintage?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      vinuos?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      wineAdvocate?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      wineSpectator?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      wineEnthusiast?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      >;
      expertRated?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'key' | 'id' | 'value'>
      ...
      adjacentVariants: Array<
        Pick<StorefrontAPI.ProductVariant, 'sku' | 'barcode'>
      >;
    }
  >;
};
...
interface GeneratedQueryTypes {
  '#graphql\n  query BlogArticles($handle: String!, $first: Int = 10) {\n    blog(handle: $handle) {\n      title\n      articles(first: $first) {\n        edges {\n          node {\n            id\n            title\n            handle\n            excerpt\n            publishedAt\n            image {\n              url\n              altText\n            }\n          }\n        }\n      }\n    }\n  }\n': {
