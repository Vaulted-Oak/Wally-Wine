...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      components: {
        input: createSliderInput({min: 0, max: 100, suffix: 'px'}),
      },
    }),
    defineField({
      name: 'buttonsBorder',
    ...
    defineField({
      ...
      components: {
        input: createSliderInput({min: 0, max: 50, suffix: 'px'}),
      },
    }),
    defineField({
    ...
    defineField({
      ...
      fields: [
        defineField({
          ...
          type: 'number',
          initialValue: 10,
          validation: (Rule: any) => Rule.min(4).max(40),
          components: {
            input: createSliderInput({min: 4, max: 40, suffix: 'px'}),
          },
        }),
        defineField({
          name: 'verticalSpace',
  ...
  return [
    {
      name: 'thickness',
      type: 'number',
      validation: (Rule: any) => Rule.min(0).max(12),
      components: {
        input: createSliderInput({min: 0, max: 12, suffix: 'px'}),
      },
    },
    {
      name: 'opacity',
...
function shadowFields() {
  return [
    ...
    },
    {
      ...
      type: 'number',
      validation: (Rule: any) => Rule.min(-12).max(12),
      components: {
        input: createSliderInput({min: -12, max: 12, suffix: 'px'}),
      },
    },
    {
      name: 'verticalOffset',
    ...
    },
    {
      ...
      components: {
        input: createSliderInput({min: 0, max: 20, suffix: 'px'}),
      },
    },
  ] as const;
}
