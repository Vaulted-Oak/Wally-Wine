...
import footerSection from './objects/sections/footerSection';
import imageBannerArraySection from './objects/sections/imageBannerArraySection';
import bannerCollectionSection from './objects/sections/bannerCollectionSection';
import instagramSection from './objects/sections/instagramSection';
import videoSection from './objects/sections/videoSection';
import restaurantCollectionSection from './objects/sections/restaurantCollectionSection';
import restaurantSection from './objects/sections/restaurantSection';
import imageBannerSection from './objects/sections/imageBannerSection';
import eventSection from './objects/sections/eventSection';
import eventCollectionSection from './objects/sections/eventCollectionSection';
import multiImageCarouselCollectionSection from './objects/sections/multiImageCarouselCollectionSection';
import whatWeOffer from './objects/sections/whatWeOffer';
import locationImagesSection from './objects/sections/locationImagesSection';
import columnSection from './objects/sections/columnSection';
...
const sections = [
  ...
  whatWeOffer,
  columnSection,
  multiImageCarouselCollectionSection,
  restaurantCollectionSection,
  restaurantSection,
  eventSection,
  eventCollectionSection,
